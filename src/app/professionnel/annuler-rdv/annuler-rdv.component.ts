...
export class AnnulerRdvComponent {
  ...
  deleteElement(): void {
    this.datatableService.delete(this.id, "appointements").subscribe(() => {
      this.router.navigate(['/professionnel/list-rdv']); // Navigate back to the main page or any other page after deleting
    });
  }

  cancel(): void {
    this.router.navigate(['/professionnel/list-rdv']); // Navigate back to the main page or any other page
  }
  getRdv(id: any): void {
